...
<!--==========顶部固定导行条==========-->
<?php
//    $group = user('group')->where(array('uid' => session('uid')))->select();
//?>
<script type='text/javascript'>
    var addFollow = "";
</script>
...
<div class="main">
            ...
            <div class="wb_cons">
                ...
                <div class="wb_tool">
                    ...
                    <ul>
                        ...
                        <li><span class='turn' id='{$v["id"]}'>转发</span></li>
                        <li>|</li>
                        <li class='keep-wrap'>
        ...
        <div class="weibo">
            ...
            <div class="wb_cons">
                <dl>
                    ...
                    <!--发布内容-->
                    <dd class='content'>
                        <p><span style="color:#ccc;font-weight:bold;"></span></p>
                    </dd>
                    <!--转发的微博内容-->
                        <dd>
                            <div class="wb_turn">
                ...
                <div class="wb_tool">
                    ...
                    <ul>
                        ...
                        <li><span class='turn' id='{$v.id}' tid='{$v.isturn.id}'>转发</span></li>
                        <li>|</li>
                        <li class='keep-wrap'>
                            <span class='keep' wid='{$v.id}'>收藏</span>
                            <div class='keep-up hidden'></div>
    ...
    <div id="right">
        ...
        <userinfo id='$_SESSION["uid"]'>
            ...
            <ul class='num_list'>
                <li><a href=""><strong></strong><span>关注</span></a></li>
                <li><a href=""><strong></strong><span>粉丝</span></a></li>
                <li class='noborder'>
                    <a href=""><strong></strong><span>微博</span></a>
                </li>
            </ul>
        </userinfo>
        <div class="maybe">
